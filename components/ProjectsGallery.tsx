...
const ProjectsGallery: React.FC = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Sviluppo di aree di stoccaggio e servizi a supporto della logistica portuale. Valorizzazione di terreni industriali strategici per l'import-export."
    },
    {
      id: 3,
      ...
      description: "Recupero conservativo di un complesso rurale trasformato in struttura ricettiva di lusso. Accesso ai fondi ZES per il rilancio turistico del territorio."
    },
    {
      id: 4,
      ...
      description: "Realizzazione di un parco commerciale su strada ad alto scorrimento. Strutture modulari ottimizzate per la grande distribuzione e il retail."
    }
  ];
            ...
            <div key={project.id} className="group cursor-pointer">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2 group-hover:text-blue-700 transition-colors flex items-center gap-2">
                  {project.title}
                  <ArrowUpRight size={20} className="opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 text-blue-600" />
                </h3>
