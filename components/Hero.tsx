    ...
    <section className="relative h-[650px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Cantiere attivo per lo sviluppo di progetti immobiliari logistici e industriali in Puglia"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            ...
            aria-label="Contatta gli esperti di 2D Sviluppo Immobiliare per una consulenza ZES"
          ...
          <a
            ...
            aria-label="Approfondisci le opportunità della ZES Unica nel settore terziario"
